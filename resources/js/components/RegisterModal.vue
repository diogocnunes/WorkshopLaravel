  ...
  <transition name="fade">
    ...
    >
      <form
        ...
        style="width: 500px;"
      >
        <label for="name" class="text-gray-600 mt-6 mb-2">Name</label>
        <input
          type="text"
          name="name"
          v-model="form.name"
        ...
        <label for="password_confirmation" class="text-gray-600 mt-6 mb-2">Password Confirmation</label>
        <input
          type="password"
...
export default {
  mounted() {
    Event.$on("toggleModal", route => {
      console.log(route);
      if (route === "register") this.isVisible = !this.isVisible;
    });
  },
